...
/* Command-line: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/gperf --language=ANSI-C -t -T -E -o -k '1,$,2,5' -S8 keywords.gperf  */
